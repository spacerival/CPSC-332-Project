  ...
  <body>
    ...
    <div class="format">
      ...
      <form>
        ...
        <input type="text" id="address" name="address" size="75"><br>
        ...
        <p><b>What type of home do you currently live in?</b></p>
        <input type="radio" id="house" name="home-type" value="house">
        ...
        <p><b>Do you rent or own?</b></p>
        <input type="radio" id="renter" name="is-rent" value="renter">
        ...
        <p><b>If you're <em>renting</em>, do you have permission from your landlord to keep pets?</b></p>
        ...
        <p><b>Have you owned a pet before?</b></p>
        <input type="radio" id="has-pet-experience" name="pet-experience" value="has-pet-experience">
        ...
        <p><b>If you <em>have</em> owned a pet before, what kinds?</b></p>
        ...
        <label for="owned-rodent">Rodent</label>

        <p><b>Do you currently have other pets?</b></p>
        <input type="radio" id="has-pet-experience" name="pet-experience" value="has-pet-experience">
        <label for="has-pet-experience">Yes, I do</label><br>
        <input type="radio" id="no-pet-experience" name="pet-experience" value="no-pet-experience">
        <label for="no-pet-experience">No, I don't</label>

        <p><b>If you <em>do</em> currently own pets, please describe them</b></p>
        <textarea id="pet-description" name="pet-description" rows="5" cols="75"></textarea>
        
        <h2>Household Information</h2>
        <label for="household-num">How many people currently live in your household?</label>
        <input type="number" id="household-num" name="household-num">

        <p><b>Do you have children?</b></p>
        <input type="radio" id="has-children" name="children-status" value="has-children">
        ...
        <p><b>If you <em>do</em> have children, please state how many and hold old each of them are</b></p>
        <textarea id="children-description" name="children-description" rows="5" cols="75"></textarea>

        <h2>Adoption Questions</h2>
        <p><b>Which pet are you interested in adopting?</b></p>
        <input type="text" placeholder="*later implement dropdown here*" size="25"><br>
        <p><b>Why do you want to adopt this pet?</b></p>
        <textarea id="adoption-reason" name="adoption-reason" rows="5" cols="75"></textarea>
        <br>
        <label for="hours-pet-alone">How many hours a day will the pet be alone?</label>
        <select name="hours-pet-alone" id="hours-pet-alone">
          <option value="alone-02">0 - 2</option>
          <option value="alone-35">3 - 5</option>
          <option value="alone-68">6 - 8</option>
          <option value="alone-9+">9+</option>
        </select><br>
